...
foreach ($recent_posts as $recent) {
	...
	$strLink = '<a href="' . $link . '" class="homebox_link_a btn">More</a>';
?>
	<div class="homebox">
		<a href="<?php echo $link ?>">
			<div class="homebox_image"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/whats_new.png" /></div>
